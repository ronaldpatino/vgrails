...
class AppListButtonBar extends HorizontalLayout {
  ...
  def AppListButtonBar(String caption){
    ...
    btnNew = new Button(AppConstant.STR_NEW)
    btnNew.setDescription "Entry new data to form"
    btnNew.icon = new ThemeResource(AppConstant.ICON_ADD)
    btnNew.setWidth "80px"

    btnRefresh = new Button(AppConstant.STR_REFRESH)
     btnRefresh.icon = new ThemeResource(AppConstant.ICON_REFRESH)
